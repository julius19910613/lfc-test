...
NER_SERVER_IP="$REMOTE_IP:10525";
CCS_UI_IP="$REMOTE_IP:8110";
CCS_CONTROLLER_IP="$REMOTE_IP:10000";
CCS_DAL_IP="$REMOTE_IP:16256";
LICENSE_CONTROLLER_IP="$REMOTE_IP:20688";
API_ADAPTER="$REMOTE_IP:8280";
ROBOT_MANAGE_UI_IP="$REMOTE_IP:8220";
...
do
  echo $line | sed -e "s/\${SELF_IP}/$SELF_IP/g" | \
    ...
    sed -e "s/\${NER_SERVER_IP}/$NER_SERVER_IP/g" | \
    sed -e "s/\${CCS_UI_IP}/$CCS_UI_IP/g" | \
    sed -e "s/\${CCS_CONTROLLER_IP}/$CCS_CONTROLLER_IP/g" | \
    sed -e "s/\${CCS_DAL_IP}/$CCS_DAL_IP/g" | \
    sed -e "s/\${LICENSE_CONTROLLER_IP}/$LICENSE_CONTROLLER_IP/g" | \
    sed -e "s/\${ROBOT_MANAGE_UI_IP}/$ROBOT_MANAGE_UI_IP/g" | \
    sed -e "s/\${API_ADAPTER}/$API_ADAPTER/g" >> nginx.conf
...
echo "NER_SERVER_IP  : $NER_SERVER_IP";
echo "CCS_UI_IP  : $CCS_UI_IP";
echo "CCS_CONTROLLER_IP  : $CCS_CONTROLLER_IP";
echo "CCS_DAL_IP  : $CCS_DAL_IP";
echo "LICENSE_CONTROLLER_IP  : $LICENSE_CONTROLLER_IP";
echo "API_ADAPTER  : $API_ADAPTER";
echo "ROBOT_MANAGE_UI_IP  : $ROBOT_MANAGE_UI_IP";
