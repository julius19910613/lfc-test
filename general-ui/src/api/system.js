...
function validateGetIconURL(iconType, enterprise) {
  return this.$reqGet(getIconURL(iconType, enterprise));
}
...
function fetchProducts(userId) {
  return this.$reqGet(`/auth/v5/user/${userId}/products`).then(res => res.data);
}
