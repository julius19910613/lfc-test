...
const COMMAND_IMPORT = '/api/v1/bf/cmds/import';
const COMMAND_EXPORT = '/api/v1/bf/cmds/export';
const COMMAND_REPORT = '/api/v1/bf/cmds/report';
...
function commandExport() {
  return this.$reqGet(COMMAND_EXPORT, {
    responseType: 'blob',
  }).then(res => res);
}

function getCommandImport(id) {
  return this.$reqGet(`${COMMAND_IMPORT}/${id}`, {}, {
  }).then(res => res.data);
}

function commandImport(form) {
  return this.$reqPost(COMMAND_IMPORT, form, {
    headers: {
...
function ImportCommandReport(id) {
  return this.$reqGet(`${COMMAND_REPORT}/${id}`, {}, {
    params: {
      responseType: 'blob',
    },
  }).then(res => res);
