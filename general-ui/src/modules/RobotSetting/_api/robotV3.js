...
const ROBOT_DIMENSION = '/adm/system/dimensionlist';
...
function getRobotDimension(id) {
  const appid = id || this.$cookie.get('appid');
  return this.$reqGet(`${ROBOT_DIMENSION}/${appid}`).then(rsp => rsp.data);
}
