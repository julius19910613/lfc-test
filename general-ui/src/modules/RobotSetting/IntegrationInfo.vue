    ...
    <div class="card w-fill h-fill">
      ...
      <div class="content">
        ...
        <div class="wechat-box">
          ...
          <div class="item" @click="popUpMessenger">
            <img src="../../assets/images/messenger.svg">
            <p class="desc">{{$t('robot_setting.messenger_str')}}</p>
            <p class="try">{{$t('robot_setting.try_now')}}</p>
          </div>
          <div class="item" @click="popUpLine">
            <img src="../../assets/images/line.svg">
            <p class="desc">{{$t('robot_setting.line_str')}}</p>
            <p class="try">{{$t('robot_setting.try_now')}}</p>
          </div>
        </div>
          <div class="wechat-box">
            <div class="item" @click="popUpWXAndroid">
              <img src="../../assets/images/wx_android.svg">
              <p class="desc">{{$t('robot_setting.wechat_android')}}</p>
              <p class="try">{{$t('robot_setting.try_now')}}</p>
            </div>
        </div>
      </div>
...
import WechatXzz from './_components/WechatXzz';
// import WechatAndroid from './_components/WechatAndroid';
import WechatBindEnterprise from './_components/WechatBindEnterprise';
import MessengerPopupView from './_components/MessengerPopupView';
import LinePopupView from './_components/LinePopupView';
...
export default {
  ...
  methods: {
    ...
    popUpWXAndroid() {
      const options = {
        title: this.$t('robot_setting.wechat_android'),
        component: WechatXzz,
        data: {
          readonly: true,
        },
    ...
    popUpMessenger() {
      ...
      const options = {
        title: this.$t('robot_setting.messenger_str'),
        component: MessengerPopupView,
        data: {
          readonly: true,
        },
        buttons: ['cancel', 'ok'],
    ...
    popUpLine() {
      ...
      const options = {
        title: this.$t('robot_setting.line_str'),
        component: LinePopupView,
        data: {
          readonly: true,
        },
        buttons: ['cancel', 'ok'],
