...
const REMOVE_WHITE_URL = '/white_word/word/delete_all_word';
...
function SpecialApiGetBannedWordList(appId) {
  const params = {
    appId,
    keyType: 1,
    catalogId: 15,
...
// 白名单 - 删除
function ApiRemoveWhite(body) {
  return this.$reqDelete(REMOVE_WHITE_URL, {}, body).then(rsp => rsp.data);
}
