<template>
  <div>
    <div class="card h-fill w-fill">
      ...
      <div class="header">
          <div class="title">
              {{$t('management.enterprise_privilege_manage')}}
          </div>
          <div class="opeartions">
              <el-input
                ...
                <!-- <el-button @click="popAddUser(2)">{{ $t('management.add_account') }}</el-button> -->
                <el-button @click="goRoleList">{{ $t('management.privilege_setting') }}</el-button>
          </div>
      ...
      <div class="page">
          <div class="local-skill-list">
              <div class="group-list">
                <emoti-card
                    type="new"
                    :title="this.$t('management.add_account')"
                    @click="popAddUser(2)"
                >
                </emoti-card>
                <emoti-card
                    v-for="(group, index) in showUsers" :key="index"
                    :showStatus="false"
                    :title="group.display_name"
                    :text="group.type_text"
                    :cardData="group"
