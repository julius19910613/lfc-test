<template>
  ...
  <div class="dropdown-select" :style="styleObj">
    ...
    <div ref="list" v-if="show" class="select-list" :style="listStyle">
      ...
      <div class="select-item-block" :style="customheight">
        ...
        <template v-else>
          <div class="select-item item" v-show="clearcheckflag">
            <div class="select-text not-selectable" :style="selectTextStyle" @click="clearcheck">
              {{$t('general.clearchecked')}}
            </div>
          </div>
