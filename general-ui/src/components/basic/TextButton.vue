...
const buttonTypes = ['default', 'fill', 'primary', 'blue', 'disable', 'error'];
...
$btn-primary-bg-color: $color-btn-primary;
$btn-primary-color: $color-white;

$btn-blue-bg-color: $color-primary;
$btn-blue-color: $color-white;
