...
.icon {
  ...
  @include iconType("material_del");
  @include iconType("info_doc");
  @include iconType("doc");
  @include iconType("pdf");
  @include iconType("ppt");
  @include iconType("exl");
  @include iconType("audio");
  /** used on IntentEngine top panel*/
  @include iconType("slice");

  @include iconType("kg_upload");
  @include iconType("kg_template");
  @include iconType("kg_edit");
  @include iconType("kg_import");
  @include iconType("kg_export");
  @include iconType("kg_search");

  /** used on robot command */
  @include iconType("data_import");
  @include iconType("temp_down");
  @include iconType("choose_file");
  @include iconType("export_file");
