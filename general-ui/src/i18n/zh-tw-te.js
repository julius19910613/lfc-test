export default {
  task_engine_v2: {
    ...
    scenario_list_page: {
      ...
      create_new_func_scenario: '創建新功能場景',
      ...
      scenario_template: '場景模板',
      goback_scenario_list: '返回場景列表',
      view_scenario_list: '查看場景模板',
      task_flow: '任務流引擎',
      func_scenario: '功能場景',
      func_scen_instruction: '功能場景為一個個獨立的子場景，可在主場景中做靈活組合',
      scenario_templates: '場景模版庫',
      template_instruction: '通過場景模版您可快速搭建並修改場景以進行定制化配置',
      scenario_instruction: '管理任務流引擎下的多輪對話場景，進行靈活配置',
    },
    node_type: {
      entry: '入口節點',
      start: '開始',
      ...
      sub_scenario_description: '進入或退出子場景的節點',
    },
    parser: {
      none: '無',
    ...
    scenario_edit_page: {
      ...
      global_ttsinfo: {
        interrupt_speech: '好的，您說',
        silence_waitingduration: '5000',
        silence_waitingspeech: '喂，您還在嗎？請問還有什麼可以幫助您嗎？',
        silence_limit: '3',
        silence_stopspeech: '不好意思，您太久沒有說話量，我這邊先掛機了，如果有其他問題，請您重新撥打，謝謝',
        vad_time: '500',
        tts_url: 'http://',
        vsp_setting: '暫無參數',
      },
    ...
    scenario_info: {
      ...
      scenario_timeout: '超時設置（秒）',
      timeoutTooltip: '請設置30至3600之間的數值',
    },
    global_TTSinfo: {
      wait_slience_config: '靜默等待配置',
      silence_duration: '機器人靜默等待時常',
      silence_waitting: '機器人靜默等待話術',
      add_prerecording: '添加預錄音',
      cancel: '取消',
      ensure: '確定',
    },
    ...
    voice_setting_tab: {
      turn_arrange: '打斷配置',
      silence_wait_config: '靜默等待配置',
      bargein_status: '狀態',
      interrupt_speech: '暫停打斷響應話述',
      arrange_on: '開啟狀態下機器人講話會被用戶講話打斷',
      arrange_off: '關閉狀態下機器人講話不會被用戶講話打斷',
      wait_for_arrange: '機器人靜默等待配置',
      arrange: '配置',
      use_default: '使用場景默認',
      custom: '自定義',
      silenceDuration: '靜默時常',
      silenceSpeech: '靜默話術',
      add_prerecording: '添加預錄音',
      continuous_exceedance: '當靜默連續超時次數超過',
      ecxeedtime: '次,',
      end_dialogue: '則結束對話',
      silence_stopSpeech: '靜默掛斷話術',
      cancel: '取消',
      ensure: '確定',
      mute_testtime: '靜音檢測時間',
      mute_time: '時長',
      vsp_setting: 'VSP設定',
      parameter: '參數',
      pause_duration: '停頓時常',
      self_determination: '關閉狀態下靜音檢測時間为系統自定',
      Speech_Complete_Timeout: 'Speech-Complete-Timeout，即說話人已停止說話，語音識別資源成功返回結果之間所必須消耗的時間',
      Vendor_Specific_Parameters: 'VSP(Vendor-Specific-Parameters)表示ASR/TTS廠商自定義參數，場景VSP參數默認為空',
      please_select: '請選擇',
    },
    understanding_tab: {
      instruction: '為幫助機器人理解用戶回話，請選擇用戶行為/合適的解析器/用戶意圖',
      title_set: '語義理解設定',
      add_act_clissify: '+ 行為分類',
      add_intent: '+ 意圖',
      act_select: '行為分類選擇',
      delete: '刪除',
      act_clissify: '行為分類',
    ...
    edge_edit_tab2: {
      instruction_header: '根據槽位收集情況，請配置合適的操作與跳轉',
      instruction: '跳轉設置',
      instruction_hint: '（通過連線鏈接此節點與其他節點）',
      show_all: '全部展開',
      close_all: '全部收起',
      button_add_edge: '＋新增跳轉規則',
      common_edge: '通用連線',
      insert_common_edge: '插入並使用通用連線',
      exception_handle: '異常情況處理',
      label_exceed_limit: '超過輪次',
      instruction_exeed_limit: '當機器人在本節點連續回話超過',
      label_time: '次',
      label_default_goto: '預設前往',
      instruction_default_goto: '當以上所有規則都無法符合時，則',
      label_then_goto: '，則前往',
      following_content: '以下內容',
      label_tag: '跳轉統計',
      on: '開',
      off: '關',
      inputholder: '輸入標籤按回車添加',
      elseThenAnswerholder: '段落文字',
      answer: '回复',
      goto_block: '前往節點',
      create_newEdge: '創建新連線',
      you_can_do: '你可以在此處',
      paste_edge: '粘貼連線',
    },
    sub_scenario_tab: {
      instruction: '子場景設定',
      instruction_hint: '（選擇插入的子場景。當本場景作為插入子場景運行至此節點時，本節點作為返回節點，忽略子場景設置直接返回主場景。）',
      show_all: '全部展開',
      close_all: '全部收起',
      button_add_sub_scenario: '＋新增子場景',
      when_answer: '當回答狀態為',
      then_go: '則前往',
    },
    ...
    condition_block: {
      ...
      label_custom_parser_slot: '優先解析',
      label_tag_enable: '標簽開關',
      label_tag: '標簽',
    ...
    condition_action_block: {
      ...
      label_custom_parser: '自定義解析器',
      label_custom_parser_slot: '優先解析',
      label_dialog_act_parser: '對話行為分類解析器',
      label_dialog_act_parser_slot_name: '槽位名稱',
      label_parser: '解析器',
      label_source: '來源',
      label_match: '符合詞',
      label_text_response: '文字回覆',
      label_voice_response: '语音回覆',
      ...
      label_tag_enable: '標簽開關',
      label_tag: '標簽',
      jump_statistics: '跳轉統計',
      label_sub_scenario: '子場景',
      label_sub_scenario_node: '節點',
      ...
      action: {
        custom_parser: '自定義解析器',
        dialog_act_parser: '對話行為分類解析器',
        parser: '解析器',
        assign_value: '賦值',
        self_increament: '計數器自增',
        api_parser: 'Web API 調用',
        exec_script: '执行脚本',
        response_text: '文字回復',
        response_voice: '語音回復',
